...
<head>
    ...
    <link href="{{asset('user/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet" type="text/css">
        ...
        <div class="row px-xl-5">
            ...
            <div class="mt-3">
                <a href="" class="text-decoration-none">
                    <span class="h2 text-uppercase text-primary bg-dark px-2">My Pizza</span>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h2 text-uppercase text-dark bg-light px-2">My Pizza</span>
                               ...
                               <a class="btn btn-secondary dropdown-toggle rounded" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li class="align-center">
                                    <span clspanss="dropdown-item  my-3">
                                       <form action="{{route('logout')}}" method="post" class="d-inline">
                                       @csrf
                                       <button type="submit" class="col-10 offset-1 btn btn-dark text-white rounded" > <i class="fa-solid fa-right-from-bracket"></i> Logout</button>
