...
@section('content')
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            ...
            <div class="mb-3">
                   <i class="fa-solid fa-arrow-left text-dark me-3" onclick="history.back()"></i> Back
             </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <input type="hidden" name="productId" id="pizzaId" value="{{$pizza->id}}">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">{{$pizza->price}} <span>MMK</span></h3>
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid img-thumbnail w-100" src="{{asset('storage/'.$p->image)}}" alt="" style="height:230px;">
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>{{$p->price}}</h5><h6 class="text-muted ml-2">MMK</h6>
                            </div>
